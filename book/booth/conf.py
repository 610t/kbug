# -*- coding: utf-8 -*-
#
# K*BUG Booth Guide documentation build configuration file, created by
...
htmlhelp_basename = 'KBUGBoothGuidedoc'
...
latex_documents = [
    (master_doc, 'KBUGBoothGuide.tex', u'K*BUG Booth Guide Documentation',
     u'K*BUG Booth Guide', 'manual'),
]
